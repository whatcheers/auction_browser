...
logging.basicConfig(level=logging.INFO,
                    ...
                    handlers=[
                        logging.FileHandler("proxibid_geocoding.log"),
...
for table in tables:
    ...
    cursor.execute(f"SELECT location, latitude, longitude FROM `auctions`.`proxibid` WHERE location IS NOT NULL AND (latitude IS NULL OR longitude IS NULL)")
