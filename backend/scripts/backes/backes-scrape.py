...
run_command(["node", "backes-list.js"])
run_command(["python3", "backes-extract.py"])
run_command(["python3", "backes-mysql.py"])
run_command(["python3", "backes-latlong.py"])
run_command(["python3", "backes-maint.py"])
